...
console.log(getComputedStyle(message).color);//this will work
...
logo.alt='Beautiful minimalist logo'; //to change the alt
console.log(logo.alt);
...
//when you want to list the event only once
...
console.log(h1.children); //it gives a live collection
...
console.log(h1.parentElement.children); //for all the siblings
